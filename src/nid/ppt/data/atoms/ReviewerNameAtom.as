package nid.ppt.data.atoms 
{
	...
	public class ReviewerNameAtom 
	{
		 ...
		 */
		   ...
		   /**
		    * reviewerName (variable): A PrintableUnicodeString that specifies the name of the reviewer. The length, in bytes, of the field is specified by rh.recLen.
		    */
		   public var reviewerName 
		   
		public function ReviewerNameAtom() 
		{
